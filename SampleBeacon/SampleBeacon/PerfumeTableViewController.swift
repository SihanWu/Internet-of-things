//
//  PerfumeTableViewController.swift
//  SmartShop
//
...
class PerfumeTableViewController: UITableViewController {
    ...
    func loadperfume() {
        ...
        let perfume1 = Meal(name: "Channel No.5", photo: photo1, rating: 4)!
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cellIdentifier = "PerfumeTableViewCell"
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! PerfumeTableViewCell
        
        // Fetches the appropriate meal for the data source layouts
        let video = perfumes[indexPath.row]
        
        
        cell.labelName.text = video.name

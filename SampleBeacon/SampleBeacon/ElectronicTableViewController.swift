//
//  ElectronicTableViewController.swift
//  SmartShop
//
...
class ElectronicTableViewController: UITableViewController {
    ...
    func loadelectronic() {
        ...
        let electronic1 = Meal(name: "Google Glasses", photo: photo1, rating: 5)!
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! ElectronicTableViewCell
        
        // Fetches the appropriate meal for the data source layouts
        let video = electronics[indexPath.row]
    ...
    {
        self.performSegueWithIdentifier("showview5", sender: self)
        
    }
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!) {
        if (segue.identifier == "showview5") {
